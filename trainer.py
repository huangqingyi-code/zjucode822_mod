...
class Trainer:
    ...
    def __init__(
        ...
        train_dataset1: Optional[Union[Dataset, IterableDataset, "datasets.Dataset"]] = None,
        train_dataset2: Optional[Union[Dataset, IterableDataset, "datasets.Dataset"]] = None,
    ...
    def _inner_training_loop(
        ...
        train_dataloader1 = self.get_train_dataloader(self.train_dataset1)
        train_dataloader2 = self.get_train_dataloader(self.train_dataset2)
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            if hasattr(epoch_iterator, "set_epoch"):
                ...
                train_dataloader2.set_epoch(epoch)
            ...
            step = -1
            train_dataloader1_iter = train_dataloader1.__iter__()
            train_dataloader2_iter = train_dataloader2.__iter__()
            for step, inputs in enumerate(epoch_iterator):
                total_batched_samples += 1
                # print("step:",step,"rank:",self.args.local_rank)
                if step%2==0:
                    # print("------train_dataloader1--------",self.args.local_rank)
                    inputs = next(train_dataloader1_iter) 
                else:
                    # print("------train_dataloader2--------",self.args.local_rank)
                    inputs = next(train_dataloader2_iter) 
