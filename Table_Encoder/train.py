...
parser.add_argument("--save_path", type=str, default="/data0/ll/checkpoints")
...
# model param
parser.add_argument('--num_columns', default=10, type=int)
...
class Trainer:
    ...
    def prepare_data(self, shuffle=True):
        ...
        warmup_data_path = os.path.join(args.data_path, "encoder_1w.np")
        ...
        official_data_path = os.path.join(args.data_path, "encoder_8w.np")
