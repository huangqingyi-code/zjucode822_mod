...
class TableEncoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        # self.qformer = None
        self.qformer = Qformer(dim=self.dim, dim_head=128, inner_dim=3584, query_num=qformer_qnum)
        print(f"Qformer query num: {qformer_qnum}")
    ...
    def attn_pooling(self, cell_emb, table_mask):
        ...
        #     print("Qformer is not initialized")
        #     self.qformer = Qformer(dim=self.dim, dim_head=128, inner_dim=3584, query_num=5).to(cell_emb.device)
