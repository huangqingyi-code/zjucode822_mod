...
DATA_PATH=/data1/workspace/gxj/sft_datasets/t2sql/table6_new/data_spider_bird.json
EVAL_DATA_PATH=/data1/workspace/gxj/sft_datasets/merge/table4_new/merge_sft_eval.json
HEAD_COUNT=1
LR=1e-5
LR_SCHE=constant
DATA_COUNT=-1
# PRETRAINED_PATH=/data1/workspace/gxj/sft_checkpoints/tosql_20col/lr1e-5_constant_with_warmup_bs1024_bf16_onlyproj_table4_nods_new/checkpoint-336
...
MODEL_NAME=tosql_20col
EXP_NAME=lr${LR}_${LR_SCHE}_bs${BS}_bf16_onlyproj_table6_onlyspider
EVAL_STEPS=100000
SAVE_STEPS=20
