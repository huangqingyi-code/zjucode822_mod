...
DATA_PATH=/data1/workspace/gxj/sft_datasets/merge/table4_new/merge_code10.json
EVAL_DATA_PATH=/data1/workspace/gxj/sft_datasets/merge/table4_new/merge_sft_eval_5000.json
...
PRETRAINED_PATH=/data0/gxj/sft_checkpoints/20col_-1/lr1e-5_constant_with_warmup_bs1024_bf16_freezedecoder_table4_nods_new/checkpoint-300
...
MODEL_NAME=20col_-1
EXP_NAME=lr${LR}_${LR_SCHE}_bs${BS}_unfreezetwo300_decoder
EVAL_STEPS=5
SAVE_STEPS=5
